...
<body>
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:rgb(45, 178, 198)">
            <div class="container">
                <a class="navbar-brand" href="../Page/home.php">Trắc nghiệm Online</a>
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <?php foreach ($subjects as $subject): ?>
                            <li><a class="dropdown-item" href="index.php?controller=TracnghiemOnline&action=listbaithi&id_monhoc=<?php echo $subject['id_monhoc']; ?>">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto me-3">
                        <?php if (isset($_COOKIE['userName']) && isset($_COOKIE['role'])): ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white" href="#">Xin chào, <?php echo $_COOKIE['userName']; ?> (<?php echo $_COOKIE['role']; ?>)</a>
                            </li>
                            <li class="nav-item">
